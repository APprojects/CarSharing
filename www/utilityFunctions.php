<?php
	...
	function getCars(){
	    ...
	    $dati = array();
	    // imposto la URl del web-service remoto
	    curl_setopt($ch, CURLOPT_URL, 'localhost/server/api/car/read.php');
	...
	function getHistories(){
	    ...
	    $dati = array();
	    // imposto la URl del web-service remoto
	    curl_setopt($ch, CURLOPT_URL, 'localhost/server/api/history/read.php');
	...
	function getUsers(){
	    ...
	    $dati = array();
	    // imposto la URl del web-service remoto
	    curl_setopt($ch, CURLOPT_URL, 'localhost/server/api/user/read.php');
